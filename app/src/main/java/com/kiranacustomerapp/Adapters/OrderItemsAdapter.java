...
public class OrderItemsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OrderItemsAdapter(Context context, List<OrderItem> list,AddOrderFragment addOrderFragment) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            ...
            case LOAD_ORDERITEMS:
                ...
                retriveAllOrderItem(loadOrderItemsHolder,position);
    ...
    public void retriveAllOrderItem(final LoadOrderItemsHolder holder, int position) {
